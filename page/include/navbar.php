<div id="navbar" class="ui inverted menu">
    ...
    <div class="right menu">
        ...
        session_start();
        $notCU = 
        "<div class=\"item\"><div id=\"signup\" class=\"ui primary button\">Signup</div></div>
        <div class=\"item\"><div id=\"login\" class=\"ui button\">Login</div></div>";
        if (isset($_SESSION["CU_id"])) {
            ...
            if ($req->rowCount() > 0) {
                $CU = 
                "<div class=\"item\"><div id=\"CU\">" . $_SESSION["CU_email"] . "</div></div>
                <div class=\"item\"><div onclick=\"location.href='../services/logout.php';\" class=\"ui button\">Logout</div></div>";
                echo $CU;
            } else {
